...
#copy the links from file 3082 to links_first.txt without repetitions
grep -o "https://www.ynetnews.com/article/[a-zA-Z0-9]\{9\}\"" 3082 |\
 uniq > links_first.txt
#delete the last char in each line(")
sed 's/.$//' links_first.txt > links.txt
